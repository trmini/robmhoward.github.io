...
(function (Word) {
    ...
    (function (Utility) {
        ...
        Utility._normalizeSearchOptions = _normalizeSearchOptions;
    })(Utility = Word.Utility || (Word.Utility = {}));
})(Word || (Word = {}));
var Word;
(function (Word) {
    var Body = (function (_super) {
        ...
        Body.prototype.search = function (searchText, searchOptions) {
            searchOptions = Word.Utility._normalizeSearchOptions(this.context, searchOptions);
        ...
        Body.prototype.select = function (selectionMode) {
            OfficeExtension.ActionFactory.createMethodAction(this.context, this, "Select", 1 /* Read */, [selectionMode]);
        };
    ...
    var InlinePicture = (function (_super) {
        ...
        Object.defineProperty(InlinePicture.prototype, "paragraph", {
            get: function () {
                if (!this.m_paragraph) {
                    this.m_paragraph = new Word.Paragraph(this.context, OfficeExtension.ObjectPathFactory.createPropertyObjectPath(this.context, this, "Paragraph", false, false));
                }
        ...
        InlinePicture.prototype._handleResult = function (value) {
            ...
            if (!OfficeExtension.Utility.isUndefined(obj["Paragraph"])) {
                this.paragraph._handleResult(obj["Paragraph"]);
            }
            if (!OfficeExtension.Utility.isUndefined(obj["ParentContentControl"])) {
                this.parentContentControl._handleResult(obj["ParentContentControl"]);
            }
