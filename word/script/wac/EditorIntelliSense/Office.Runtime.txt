...
declare module OfficeExtension {
    ...
    class ClientRequestContext {
        ...
        executeAsync<T>(passThroughValue?: T): IPromise<T>;
...
declare module OfficeExtension {
    class ResourceStrings {
        ...
        static runTaskAsyncMustReturnPromise: string;
    }
}
declare module OfficeExtension {
...
declare module OfficeExtension {
    class Utility {
        ...
        static createRuntimeError(code: string, message: string, location: string): RuntimeError;
        static _getResourceString(resourceId: string, arg?: string): string;
