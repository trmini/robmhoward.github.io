...
(function (Word) {
	...
	var Body=(function (_super) {
		...
		Body.prototype.search=function (searchText, searchOptions) {
			...
			return new Word.SearchResultCollection(this.context, _createMethodObjectPath(this.context, this, "Search", 1 , [searchText, searchOptions], true, true, null));
		};
	...
	var SearchResultCollection=(function (_super) {
		...
		SearchResultCollection.prototype._handleIdResult=function (value) {
			_super.prototype._handleIdResult.call(this, value);
			if (_isNullOrUndefined(value)) {
				return;
			}
