...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.7331.1000";
...
(function (Word) {
	...
	var Table=(function (_super) {
		...
		Table.prototype._handleResult=function (value) {
			...
			_handleNavigationPropertyResults(this, obj, ["font", "Font", "next", "Next", "paragraphAfter", "ParagraphAfter", "paragraphBefore", "ParagraphBefore", "parentBody", "ParentBody", "parentContentControl", "ParentContentControl", "parentTable", "ParentTable", "parentTableCell", "ParentTableCell", "rows", "Rows", "tables", "Tables"]);
		};
