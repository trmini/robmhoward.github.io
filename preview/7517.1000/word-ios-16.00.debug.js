...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.7517.1000";
...
(function (Word) {
	...
	var Body=(function (_super) {
		...
		Body.prototype.search=function (searchText, searchOptions) {
			...
			return new Word.RangeCollection(this.context, _createMethodObjectPath(this.context, this, "Search", 1 , [searchText, searchOptions], true, true, null));
		};
	...
	var CustomPropertyCollection=(function (_super) {
		...
		CustomPropertyCollection.prototype.set=function (key, value) {
			return new Word.CustomProperty(this.context, _createMethodObjectPath(this.context, this, "Set", 0 , [key, value], false, false, null));
		};
	...
	var Document=(function (_super) {
		...
		Document.prototype.getBookmarkRange=function (name) {
			return new Word.Range(this.context, _createMethodObjectPath(this.context, this, "GetBookmarkRange", 0 , [name], false, false, null));
		};
	...
	var SettingCollection=(function (_super) {
		...
		SettingCollection.prototype.set=function (key, value) {
			var newValue=JSON.stringify(value);
			if (newValue !==null)
				return new Word.Setting(this.context, _createMethodObjectPath(this.context, this, "Set", 0 , [key, newValue], false, false, null));
			return new Word.Setting(this.context, _createMethodObjectPath(this.context, this, "Set", 0 , [key, value], false, false, null));
		};
	...
	var Table=(function (_super) {
		...
		Table.prototype.getCell=function (rowIndex, cellIndex) {
			return new Word.TableCell(this.context, _createMethodObjectPath(this.context, this, "GetCell", 0 , [rowIndex, cellIndex], false, false, null));
		};
