...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.7605.1000";
...
(function (Word) {
	...
	var Application=(function (_super) {
		...
		Application.prototype.createDocument=function (base64File) {
			return new Word.Document(this.context, _createMethodObjectPath(this.context, this, "CreateDocument", OfficeExtension.OperationType.Read, [base64File], false, false, null));
		};
	...
	var Body=(function (_super) {
		...
		Body.prototype.getRange=function (rangeLocation) {
			return new Word.Range(this.context, _createMethodObjectPath(this.context, this, "GetRange", OfficeExtension.OperationType.Read, [rangeLocation], false, false, null));
		};
		...
		Body.prototype.insertTable=function (rowCount, columnCount, insertLocation, values) {
			return new Word.Table(this.context, _createMethodObjectPath(this.context, this, "InsertTable", OfficeExtension.OperationType.Default, [rowCount, columnCount, insertLocation, values], false, true, null));
		};
	...
	var ContentControl=(function (_super) {
		...
		ContentControl.prototype.getTextRanges=function (endingMarks, trimSpacing) {
			return new Word.RangeCollection(this.context, _createMethodObjectPath(this.context, this, "GetTextRanges", OfficeExtension.OperationType.Read, [endingMarks, trimSpacing], true, false, null));
		};
		...
		ContentControl.prototype.split=function (delimiters, multiParagraphs, trimDelimiters, trimSpacing) {
			return new Word.RangeCollection(this.context, _createMethodObjectPath(this.context, this, "Split", OfficeExtension.OperationType.Read, [delimiters, multiParagraphs, trimDelimiters, trimSpacing], true, false, null));
		};
	...
	var ContentControlCollection=(function (_super) {
		...
		ContentControlCollection.prototype.getByTypes=function (types) {
			return new Word.ContentControlCollection(this.context, _createMethodObjectPath(this.context, this, "GetByTypes", OfficeExtension.OperationType.Read, [types], true, false, null));
		};
		ContentControlCollection.prototype.getFirst=function () {
			return new Word.ContentControl(this.context, _createMethodObjectPath(this.context, this, "GetFirst", OfficeExtension.OperationType.Read, [], false, false, null));
		};
	...
	var CustomPropertyCollection=(function (_super) {
		...
		CustomPropertyCollection.prototype.deleteAll=function () {
			_createMethodAction(this.context, this, "DeleteAll", OfficeExtension.OperationType.Default, []);
		};
		CustomPropertyCollection.prototype.getCount=function () {
			var action=_createMethodAction(this.context, this, "GetCount", OfficeExtension.OperationType.Default, []);
			var ret=new OfficeExtension.ClientResult();
			_addActionResultHandler(this, action, ret);
			return ret;
		};
		...
		CustomPropertyCollection.prototype.set=function (key, value) {
			return new Word.CustomProperty(this.context, _createMethodObjectPath(this.context, this, "Set", OfficeExtension.OperationType.Default, [key, value], false, false, null));
		};
	...
	var Document=(function (_super) {
		...
		Document.prototype.deleteBookmark=function (name) {
			_createMethodAction(this.context, this, "DeleteBookmark", OfficeExtension.OperationType.Default, [name]);
		};
		Document.prototype.getBookmarkRange=function (name) {
			return new Word.Range(this.context, _createMethodObjectPath(this.context, this, "GetBookmarkRange", OfficeExtension.OperationType.Default, [name], false, false, null));
		};
		...
		Document.prototype.open=function () {
			_createMethodAction(this.context, this, "Open", OfficeExtension.OperationType.Read, []);
		};
	...
	var InlinePicture=(function (_super) {
		...
		InlinePicture.prototype.getNext=function () {
			return new Word.InlinePicture(this.context, _createMethodObjectPath(this.context, this, "GetNext", OfficeExtension.OperationType.Read, [], false, false, null));
		};
	...
	var InlinePictureCollection=(function (_super) {
		...
		InlinePictureCollection.prototype.getFirst=function () {
			return new Word.InlinePicture(this.context, _createMethodObjectPath(this.context, this, "GetFirst", OfficeExtension.OperationType.Read, [], false, false, null));
		};
	...
	var List=(function (_super) {
		...
		List.prototype.getLevelFont=function (level) {
			return new Word.Font(this.context, _createMethodObjectPath(this.context, this, "GetLevelFont", OfficeExtension.OperationType.Read, [level], false, false, null));
		};
		List.prototype.getLevelParagraphs=function (level) {
			return new Word.ParagraphCollection(this.context, _createMethodObjectPath(this.context, this, "GetLevelParagraphs", OfficeExtension.OperationType.Read, [level], true, false, null));
		};
		List.prototype.getLevelPicture=function (level) {
			var action=_createMethodAction(this.context, this, "GetLevelPicture", OfficeExtension.OperationType.Read, [level]);
			var ret=new OfficeExtension.ClientResult();
			_addActionResultHandler(this, action, ret);
			return ret;
		};
		List.prototype.getLevelString=function (level) {
			var action=_createMethodAction(this.context, this, "GetLevelString", OfficeExtension.OperationType.Read, [level]);
			var ret=new OfficeExtension.ClientResult();
			_addActionResultHandler(this, action, ret);
			return ret;
		};
		...
		List.prototype.resetLevelFont=function (level, resetFontName) {
			_createMethodAction(this.context, this, "ResetLevelFont", OfficeExtension.OperationType.Default, [level, resetFontName]);
		};
		List.prototype.setLevelAlignment=function (level, alignment) {
			_createMethodAction(this.context, this, "SetLevelAlignment", OfficeExtension.OperationType.Default, [level, alignment]);
		};
		List.prototype.setLevelBullet=function (level, listBullet, charCode, fontName) {
			_createMethodAction(this.context, this, "SetLevelBullet", OfficeExtension.OperationType.Default, [level, listBullet, charCode, fontName]);
		};
		List.prototype.setLevelIndents=function (level, textIndent, bulletNumberPictureIndent) {
			_createMethodAction(this.context, this, "SetLevelIndents", OfficeExtension.OperationType.Default, [level, textIndent, bulletNumberPictureIndent]);
		};
		List.prototype.setLevelNumbering=function (level, listNumbering, formatString) {
			_createMethodAction(this.context, this, "SetLevelNumbering", OfficeExtension.OperationType.Default, [level, listNumbering, formatString]);
		};
		List.prototype.setLevelPicture=function (level, base64EncodedImage) {
			_createMethodAction(this.context, this, "SetLevelPicture", OfficeExtension.OperationType.Default, [level, base64EncodedImage]);
		};
		List.prototype.setLevelStartingNumber=function (level, startingNumber) {
			_createMethodAction(this.context, this, "SetLevelStartingNumber", OfficeExtension.OperationType.Default, [level, startingNumber]);
		};
	...
	var ListCollection=(function (_super) {
		...
		ListCollection.prototype.getById=function (id) {
			return new Word.List(this.context, _createMethodObjectPath(this.context, this, "GetById", OfficeExtension.OperationType.Read, [id], false, false, null));
		};
		ListCollection.prototype.getFirst=function () {
			return new Word.List(this.context, _createMethodObjectPath(this.context, this, "GetFirst", OfficeExtension.OperationType.Read, [], false, false, null));
		};
	...
	var ListItem=(function (_super) {
		...
		ListItem.prototype.getAncestor=function (parentOnly) {
			return new Word.Paragraph(this.context, _createMethodObjectPath(this.context, this, "GetAncestor", OfficeExtension.OperationType.Read, [parentOnly], false, false, null));
		};
		ListItem.prototype.getDescendants=function (directChildrenOnly) {
			return new Word.ParagraphCollection(this.context, _createMethodObjectPath(this.context, this, "GetDescendants", OfficeExtension.OperationType.Read, [directChildrenOnly], true, false, null));
		};
	...
	var Paragraph=(function (_super) {
		...
		Paragraph.prototype.attachToList=function (listId, level) {
			return new Word.List(this.context, _createMethodObjectPath(this.context, this, "AttachToList", OfficeExtension.OperationType.Default, [listId, level], false, false, null));
		};
		...
		Paragraph.prototype.detachFromList=function () {
			_createMethodAction(this.context, this, "DetachFromList", OfficeExtension.OperationType.Default, []);
		};
		...
		Paragraph.prototype.getNext=function () {
			return new Word.Paragraph(this.context, _createMethodObjectPath(this.context, this, "GetNext", OfficeExtension.OperationType.Read, [], false, false, null));
		};
		...
		Paragraph.prototype.getPrevious=function () {
			return new Word.Paragraph(this.context, _createMethodObjectPath(this.context, this, "GetPrevious", OfficeExtension.OperationType.Read, [], false, false, null));
		};
		...
		Paragraph.prototype.split=function (delimiters, trimDelimiters, trimSpacing) {
			return new Word.RangeCollection(this.context, _createMethodObjectPath(this.context, this, "Split", OfficeExtension.OperationType.Read, [delimiters, trimDelimiters, trimSpacing], true, false, null));
		};
		Paragraph.prototype.startNewList=function () {
			return new Word.List(this.context, _createMethodObjectPath(this.context, this, "StartNewList", OfficeExtension.OperationType.Default, [], false, false, null));
		};
	...
	var ParagraphCollection=(function (_super) {
		...
		ParagraphCollection.prototype.getFirst=function () {
			return new Word.Paragraph(this.context, _createMethodObjectPath(this.context, this, "GetFirst", OfficeExtension.OperationType.Read, [], false, false, null));
		};
		ParagraphCollection.prototype.getLast=function () {
			return new Word.Paragraph(this.context, _createMethodObjectPath(this.context, this, "GetLast", OfficeExtension.OperationType.Read, [], false, false, null));
		};
	...
	var Range=(function (_super) {
		...
		Range.prototype.compareLocationWith=function (range) {
			var action=_createMethodAction(this.context, this, "CompareLocationWith", OfficeExtension.OperationType.Read, [range]);
			var ret=new OfficeExtension.ClientResult();
			_addActionResultHandler(this, action, ret);
			return ret;
		};
		...
		Range.prototype.expandTo=function (range) {
			return new Word.Range(this.context, _createMethodObjectPath(this.context, this, "ExpandTo", OfficeExtension.OperationType.Default, [range], false, false, null));
		};
		Range.prototype.getBookmarks=function (includeHidden, includeAdjacent) {
			var action=_createMethodAction(this.context, this, "GetBookmarks", OfficeExtension.OperationType.Read, [includeHidden, includeAdjacent]);
			var ret=new OfficeExtension.ClientResult();
			_addActionResultHandler(this, action, ret);
			return ret;
		};
		...
		Range.prototype.getHyperlinkRanges=function () {
			return new Word.RangeCollection(this.context, _createMethodObjectPath(this.context, this, "GetHyperlinkRanges", OfficeExtension.OperationType.Read, [], true, false, null));
		};
		Range.prototype.getNextTextRange=function (endingMarks, trimSpacing) {
			return new Word.Range(this.context, _createMethodObjectPath(this.context, this, "GetNextTextRange", OfficeExtension.OperationType.Read, [endingMarks, trimSpacing], false, false, null));
		};
		...
		Range.prototype.insertBookmark=function (name) {
			_createMethodAction(this.context, this, "InsertBookmark", OfficeExtension.OperationType.Default, [name]);
		};
		...
		Range.prototype.intersectWith=function (range) {
			return new Word.Range(this.context, _createMethodObjectPath(this.context, this, "IntersectWith", OfficeExtension.OperationType.Default, [range], false, false, null));
		};
	...
	var RangeCollection=(function (_super) {
		...
		RangeCollection.prototype.getFirst=function () {
			return new Word.Range(this.context, _createMethodObjectPath(this.context, this, "GetFirst", OfficeExtension.OperationType.Read, [], false, false, null));
		};
	...
	var Section=(function (_super) {
		...
		Object.defineProperty(Section.prototype, "headerFooterEvenPageDifferent", {
			get: function () {
				_throwIfNotLoaded("headerFooterEvenPageDifferent", this.m_headerFooterEvenPageDifferent, "Section", this._isNull);
				return this.m_headerFooterEvenPageDifferent;
			},
			set: function (value) {
				this.m_headerFooterEvenPageDifferent=value;
				_createSetPropertyAction(this.context, this, "HeaderFooterEvenPageDifferent", value);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Section.prototype, "headerFooterFirstPageDifferent", {
			get: function () {
				_throwIfNotLoaded("headerFooterFirstPageDifferent", this.m_headerFooterFirstPageDifferent, "Section", this._isNull);
				return this.m_headerFooterFirstPageDifferent;
			},
			set: function (value) {
				this.m_headerFooterFirstPageDifferent=value;
				_createSetPropertyAction(this.context, this, "HeaderFooterFirstPageDifferent", value);
			},
			enumerable: true,
			configurable: true
		});
		...
		Section.prototype.getNext=function () {
			return new Word.Section(this.context, _createMethodObjectPath(this.context, this, "GetNext", OfficeExtension.OperationType.Read, [], false, false, null));
		};
		...
		Section.prototype._handleResult=function (value) {
			...
			var obj=value;
			_fixObjectPathIfNecessary(this, obj);
			if (!_isUndefined(obj["HeaderFooterEvenPageDifferent"])) {
				this.m_headerFooterEvenPageDifferent=obj["HeaderFooterEvenPageDifferent"];
			}
			if (!_isUndefined(obj["HeaderFooterFirstPageDifferent"])) {
				this.m_headerFooterFirstPageDifferent=obj["HeaderFooterFirstPageDifferent"];
			}
			if (!_isUndefined(obj["_Id"])) {
				this.m__Id=obj["_Id"];
			}
		...
		Section.prototype.toJSON=function () {
			return {
				"body": this.m_body,
				"headerFooterEvenPageDifferent": this.m_headerFooterEvenPageDifferent,
				"headerFooterFirstPageDifferent": this.m_headerFooterFirstPageDifferent
			};
		};
		return Section;
	}(OfficeExtension.ClientObject));
	...
	var SectionCollection=(function (_super) {
		...
		SectionCollection.prototype.getFirst=function () {
			return new Word.Section(this.context, _createMethodObjectPath(this.context, this, "GetFirst", OfficeExtension.OperationType.Read, [], false, false, null));
		};
	...
	var SettingCollection=(function (_super) {
		...
		SettingCollection.prototype.set=function (key, value) {
			var newValue=JSON.stringify(value);
			if (newValue !==null)
				return new Word.Setting(this.context, _createMethodObjectPath(this.context, this, "Set", OfficeExtension.OperationType.Default, [key, newValue], false, false, null));
			return new Word.Setting(this.context, _createMethodObjectPath(this.context, this, "Set", OfficeExtension.OperationType.Default, [key, value], false, false, null));
		};
	...
	var Table=(function (_super) {
		...
		Table.prototype.addColumns=function (insertLocation, columnCount, values) {
			_createMethodAction(this.context, this, "AddColumns", OfficeExtension.OperationType.Default, [insertLocation, columnCount, values]);
		};
		Table.prototype.addRows=function (insertLocation, rowCount, values) {
			return new Word.TableRowCollection(this.context, _createMethodObjectPath(this.context, this, "AddRows", OfficeExtension.OperationType.Default, [insertLocation, rowCount, values], true, false, null));
		};
		Table.prototype.autoFitContents=function () {
			_createMethodAction(this.context, this, "AutoFitContents", OfficeExtension.OperationType.Default, []);
		};
		Table.prototype.autoFitWindow=function () {
			_createMethodAction(this.context, this, "AutoFitWindow", OfficeExtension.OperationType.Default, []);
		};
		...
		Table.prototype.deleteColumns=function (columnIndex, columnCount) {
			_createMethodAction(this.context, this, "DeleteColumns", OfficeExtension.OperationType.Default, [columnIndex, columnCount]);
		};
		Table.prototype.deleteRows=function (rowIndex, rowCount) {
			_createMethodAction(this.context, this, "DeleteRows", OfficeExtension.OperationType.Default, [rowIndex, rowCount]);
		};
		Table.prototype.distributeColumns=function () {
			_createMethodAction(this.context, this, "DistributeColumns", OfficeExtension.OperationType.Default, []);
		};
		Table.prototype.distributeRows=function () {
			_createMethodAction(this.context, this, "DistributeRows", OfficeExtension.OperationType.Default, []);
		};
		Table.prototype.getBorder=function (borderLocation) {
			return new Word.TableBorder(this.context, _createMethodObjectPath(this.context, this, "GetBorder", OfficeExtension.OperationType.Read, [borderLocation], false, false, null));
		};
		Table.prototype.getCell=function (rowIndex, cellIndex) {
			return new Word.TableCell(this.context, _createMethodObjectPath(this.context, this, "GetCell", OfficeExtension.OperationType.Default, [rowIndex, cellIndex], false, false, null));
		};
		Table.prototype.getCellPadding=function (cellPaddingLocation) {
			var action=_createMethodAction(this.context, this, "GetCellPadding", OfficeExtension.OperationType.Read, [cellPaddingLocation]);
			var ret=new OfficeExtension.ClientResult();
			_addActionResultHandler(this, action, ret);
			return ret;
		};
		Table.prototype.getNext=function () {
			return new Word.Table(this.context, _createMethodObjectPath(this.context, this, "GetNext", OfficeExtension.OperationType.Read, [], false, false, null));
		};
		...
		Table.prototype.mergeCells=function (topRow, firstCell, bottomRow, lastCell) {
			return new Word.TableCell(this.context, _createMethodObjectPath(this.context, this, "MergeCells", OfficeExtension.OperationType.Default, [topRow, firstCell, bottomRow, lastCell], false, true, null));
		};
		...
		Table.prototype.setCellPadding=function (cellPaddingLocation, cellPadding) {
			_createMethodAction(this.context, this, "SetCellPadding", OfficeExtension.OperationType.Default, [cellPaddingLocation, cellPadding]);
		};
	...
	var TableCollection=(function (_super) {
		...
		TableCollection.prototype.getFirst=function () {
			return new Word.Table(this.context, _createMethodObjectPath(this.context, this, "GetFirst", OfficeExtension.OperationType.Read, [], false, false, null));
		};
	...
	var TableRow=(function (_super) {
		...
		TableRow.prototype.getNext=function () {
			return new Word.TableRow(this.context, _createMethodObjectPath(this.context, this, "GetNext", OfficeExtension.OperationType.Read, [], false, false, null));
		};
		TableRow.prototype.insertRows=function (insertLocation, rowCount, values) {
			return new Word.TableRowCollection(this.context, _createMethodObjectPath(this.context, this, "InsertRows", OfficeExtension.OperationType.Read, [insertLocation, rowCount, values], true, false, null));
		};
		TableRow.prototype.merge=function () {
			return new Word.TableCell(this.context, _createMethodObjectPath(this.context, this, "Merge", OfficeExtension.OperationType.Default, [], false, false, null));
		};
	...
	var TableRowCollection=(function (_super) {
		...
		TableRowCollection.prototype.getFirst=function () {
			return new Word.TableRow(this.context, _createMethodObjectPath(this.context, this, "GetFirst", OfficeExtension.OperationType.Read, [], false, false, null));
		};
	...
	var TableCell=(function (_super) {
		...
		TableCell.prototype.deleteColumn=function () {
			_createMethodAction(this.context, this, "DeleteColumn", OfficeExtension.OperationType.Default, []);
		};
		TableCell.prototype.deleteRow=function () {
			_createMethodAction(this.context, this, "DeleteRow", OfficeExtension.OperationType.Default, []);
		};
		...
		TableCell.prototype.getNext=function () {
			return new Word.TableCell(this.context, _createMethodObjectPath(this.context, this, "GetNext", OfficeExtension.OperationType.Read, [], false, false, null));
		};
		TableCell.prototype.insertColumns=function (insertLocation, columnCount, values) {
			_createMethodAction(this.context, this, "InsertColumns", OfficeExtension.OperationType.Default, [insertLocation, columnCount, values]);
		};
		TableCell.prototype.insertRows=function (insertLocation, rowCount, values) {
			return new Word.TableRowCollection(this.context, _createMethodObjectPath(this.context, this, "InsertRows", OfficeExtension.OperationType.Default, [insertLocation, rowCount, values], true, false, null));
		};
		...
		TableCell.prototype.split=function (rowCount, columnCount) {
			_createMethodAction(this.context, this, "Split", OfficeExtension.OperationType.Default, [rowCount, columnCount]);
		};
	...
	var TableCellCollection=(function (_super) {
		...
		TableCellCollection.prototype.getFirst=function () {
			return new Word.TableCell(this.context, _createMethodObjectPath(this.context, this, "GetFirst", OfficeExtension.OperationType.Read, [], false, false, null));
		};
