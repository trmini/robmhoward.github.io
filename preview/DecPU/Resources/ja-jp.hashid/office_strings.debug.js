...
Strings.OfficeOM.L_InvalidArgument = "[alUhT]［The argument '{0}' is invalid or missing or has an incorrect format.］";
...
Strings.OfficeOM.L_PropertyNotLoaded = "[WhYjj]［The property '{0}' is not available. You must call the load method on the containing object and call executeAsync on the request context before reading the property's value.］";
...
Strings.OfficeOM.L_InvalidObjectPath = "[Zg5om]［The object path '{0}' is not valid.］";
