...
OSF.InitializationHelper.prototype.loadAppSpecificScriptAndCreateOM=function OSF_InitializationHelper$loadAppSpecificScriptAndCreateOM(appContext, appReady, basePath)
{
	...
	OSF.DDA.OutlookAppOm.prototype={
		...
		displayMessageForm: function(itemId)
		{
			...
			this.invokeHostMethod(8,{itemId: itemId},null)
		},
		displayAppointmentForm: function(itemId)
		{
			if($h.ScriptHelpers.isNullOrUndefined(itemId))
				throw Error.argumentNull("itemId");
			this.invokeHostMethod(9,{itemId: itemId},null)
		},
	...
	OSF.DDA.Settings.prototype={
		...
		_saveSettingsForOwa$p$0: function(callback, userContext)
		{
			var serializedSettings=OSF.DDA.SettingsManager.serializeSettings(this.get__data$p$0());
			var $$t_7=this;
			OSF.DDA.OutlookAppOm._instance$p.invokeHostMethod(404,[serializedSettings],function(resultCode, response)
			{
				if(callback)
				{
					var asyncResult;
	...
	$h.Body.prototype={getAsync: function(coercionType)
		{
			...
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(37,dataToHost,null,commonParameters._asyncContext$p$0,commonParameters._callback$p$0)
		}};
	...
	$h.ComposeBody.prototype={
		getTypeAsync: function()
		{
			...
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(14,null,null,parameters._asyncContext$p$0,parameters._callback$p$0)
		},
		setSelectedDataAsync: function(data)
		{
			...
			if(!dataToHost)
				return;
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(13,dataToHost,null,parameters._asyncContext$p$0,parameters._callback$p$0)
		},
		prependAsync: function(data)
		{
			...
			if(!dataToHost)
				return;
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(23,dataToHost,null,parameters._asyncContext$p$0,parameters._callback$p$0)
		},
		setAsync: function(data)
		{
			...
			if(!dataToHost)
				return;
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(38,dataToHost,null,parameters._asyncContext$p$0,parameters._callback$p$0)
		}
	};
	...
	$h.ComposeItem.prototype={
		...
		addFileAttachmentAsync: function(uri, attachmentName)
		{
			...
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(16,parameters,null,commonParameters._asyncContext$p$0,commonParameters._callback$p$0)
		},
		addItemAttachmentAsync: function(itemId, attachmentName)
		{
			...
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(19,parameters,null,commonParameters._asyncContext$p$0,commonParameters._callback$p$0)
		},
		removeAttachmentAsync: function(attachmentId)
		{
			...
			var commonParameters=$h.CommonParameters.parse(args,false);
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(20,{attachmentIndex: attachmentId},null,commonParameters._asyncContext$p$0,commonParameters._callback$p$0)
		},
		getSelectedDataAsync: function(coercionType)
		{
			...
			if(coercionType !==Microsoft.Office.WebExtension.CoercionType.Html && coercionType !==Microsoft.Office.WebExtension.CoercionType.Text || !($$t_6=$h.Body._tryMapToHostCoercionType$i(coercionType,$$t_5={val: hostCoercionType}),hostCoercionType=$$t_5.val,$$t_6))
				throw Error.argument("coercionType");
			var dataToHost={coercionType: hostCoercionType};
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(28,dataToHost,null,commonParameters._asyncContext$p$0,commonParameters._callback$p$0)
		},
		setSelectedDataAsync: function(data)
		{
			var args=[];
			...
			if(!dataToHost)
				return;
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(29,dataToHost,null,parameters._asyncContext$p$0,parameters._callback$p$0)
		},
		close: function()
		{
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(41,null,null,null,null)
		},
		...
		saveAsync: function()
		{
			...
			var parameters=$h.CommonParameters.parse(args,false);
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(32,null,null,parameters._asyncContext$p$0,parameters._callback$p$0)
		}
	};
	...
	$h.ComposeRecipient.prototype={
		...
		getAsync: function()
		{
			...
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(15,{recipientField: this._type$p$0},$h.ComposeRecipient._getAsyncFormatter$p,parameters._asyncContext$p$0,parameters._callback$p$0)
		},
		...
		setAddHelper: function(recipients, args, isSet)
		{
			...
			if(Array.isInstanceOfType(recipients))
				...
				throw Error.argument("recipients");
			var $$t_B=this;
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(isSet ? 21 : 22,{
	...
	$h.ComposeLocation.prototype={
		getAsync: function()
		{
			...
			var parameters=$h.CommonParameters.parse(args,true);
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(26,null,null,parameters._asyncContext$p$0,parameters._callback$p$0)
		},
		setAsync: function(location)
		{
			...
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(27,{location: location},null,parameters._asyncContext$p$0,parameters._callback$p$0)
		}
	};
	...
	$h.ComposeSubject.prototype={
		getAsync: function()
		{
			...
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(18,null,null,parameters._asyncContext$p$0,parameters._callback$p$0)
		},
		setAsync: function(data)
		{
			var args=[];
			...
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(17,{subject: data},null,parameters._asyncContext$p$0,parameters._callback$p$0)
		}
	};
	...
	$h.ComposeTime.prototype={
		...
		getAsync: function()
		{
			...
			var parameters=$h.CommonParameters.parse(args,true);
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(24,{TimeProperty: this._timeType$p$0},this.$$d__ticksToDateFormatter$p$0,parameters._asyncContext$p$0,parameters._callback$p$0)
		},
		setAsync: function(dateTime)
		{
			...
			var parameters=$h.CommonParameters.parse(args,false);
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(25,{
	...
	$h.NotificationMessages.prototype={
		addAsync: function(key, dictionary)
		{
			...
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(33,dataToHost,null,commonParameters._asyncContext$p$0,commonParameters._callback$p$0)
		},
		getAllAsync: function()
		{
			...
			var commonParameters=$h.CommonParameters.parse(args,true);
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(34,null,null,commonParameters._asyncContext$p$0,commonParameters._callback$p$0)
		},
		replaceAsync: function(key, dictionary)
		{
			...
			dataToHost["key"]=key;
			$h.NotificationMessages._mapToHostItemNotificationMessageType$p(dataToHost);
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(35,dataToHost,null,commonParameters._asyncContext$p$0,commonParameters._callback$p$0)
		},
		removeAsync: function(key)
		{
			...
			OSF.DDA.OutlookAppOm._instance$p._standardInvokeHostMethod$i$0(36,dataToHost,null,commonParameters._asyncContext$p$0,commonParameters._callback$p$0)
		}
	};
	...
	$h.RequestBase.prototype={
		...
		_sendRequest$i$0: function(dispid, methodName, dataToSend)
		{
			...
			var $$t_5=this;
			OSF.DDA.OutlookAppOm._instance$p.invokeHostMethod(dispid,dataToSend,function(resultCode, response)
			{
				if(resultCode)
	...
	OSF.DDA.OutlookAppOm.executeMethodName="ExecuteMethod";
	OSF.DDA.OutlookAppOm.getInitialDataMethodName="GetInitialData";
