...
Strings.OfficeOM.L_RunMustReturnPromise = 'لم ترجع الوظيفة الدفعية التي تم تمريرها إلى أسلوب ".run" أي تعهد. يجب أن تُرجع الوظيفة أي تعهد، بحيث يمكن إصدار أي كائنات يتم تعقبها تلقائياً عند اكتمال العملية الدفعية. عادةً، يمكن إرجاع التعهد بإرجاع الاستجابة من"context.sync()".';
...
Strings.OfficeOM.L_ValueNotLoaded = 'لإ The value of the result object has not been loaded yet. Before reading the value property, call "context.sync()" on the associated request context.هقشؤصهقشؤصهقشؤص أبعَد2؟';
