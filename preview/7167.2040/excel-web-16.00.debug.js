	...
	(function (AddinNativeAction) {
		...
		(function (Dialog) {
			...
			function showDialog(dialogInfo) {
				...
				var windowSpecs="width="+width+", height="+height+",channelmode=no,directories=no,fullscreen=no,location=no,menubar=no,resizable=yes,scrollbars=yes,status=no,titlebar=yes,toolbar=no";
...
OSF.DDA.WAC.Delegate.openDialog=function OSF_DDA_WAC_Delegate$OpenDialog(args) {
	...
	if (OSF.DialogShownStatus.hasDialogShown) {
		...
		if (dialogInfo[OSF.ShowWindowDialogParameterKeys.XFrameDenySafe]) {
			...
			dialogNotificationPanel.style.cssText="width:100%;height:120px;position:absolute;z-index:10;background-color:rgba(255, 255, 255, 1)";
			var dialogNotificationTextPanel=document.createElement("div");
			dialogNotificationTextPanel.innerText=OSF.OUtil.formatString(Strings.OfficeOM.L_ShowWindowDialogNotification, OSF._OfficeAppFactory.getInitializationHelper()._appContext._addinName);
			dialogNotificationTextPanel.style.cssText="margin:20px 30px;font-family:Segoe UI;font-size:14px;height:40px";
			var dialogNotificationButtonPanel=document.createElement("div");
			dialogNotificationButtonPanel.style.cssText="margin:0px 30px;float:right";
			var allowButton=document.createElement("input");
			allowButton.setAttribute("type", "button");
			allowButton.style.cssText="text-align:center;width:70px;height:30px;font-size:15px;font-family:Segoe UI";
			allowButton.setAttribute("value", Strings.OfficeOM.L_ShowWindowDialogNotificationAllow);
			var ignoreButton=document.createElement("input");
			ignoreButton.setAttribute("type", "button");
			ignoreButton.style.cssText="text-align:center;width:70px;height:30px;font-size:15px;font-family:Segoe UI;margin-left:10px";
			ignoreButton.setAttribute("value", Strings.OfficeOM.L_ShowWindowDialogNotificationIgnore);
			...
			var dialogNotificationShownArgs={
				"dispId": OSF.DDA.EventDispId.dispidDialogNotificationShownInAddinEvent, "eventType": OSF.DDA.Marshaling.DialogNotificationShownEventType.DialogNotificationShown
			};
			allowButton.onclick=function () {
				OSF.DDA.WAC.Delegate.unregisterEventAsync(dialogNotificationShownArgs);
				document.body.removeChild(dialogNotificationPanel);
				OfficeExt.AddinNativeAction.Dialog.showDialog(dialogInfo);
			};
			...
			OSF.DDA.WAC.Delegate.registerEventAsync(dialogNotificationShownArgs);
		}
		else {
...
(function (Excel) {
	...
	var WorksheetCollection=(function (_super) {
		...
		WorksheetCollection.prototype.getItemOrNull=function (key) {
			return new Excel.Worksheet(this.context, _createMethodObjectPath(this.context, this, "GetItemOrNull", 1 , [key], false, false, null));
		};
	...
	var Range=(function (_super) {
		...
		Range.prototype.getIntersectionOrNull=function (anotherRange) {
			return new Excel.Range(this.context, _createMethodObjectPath(this.context, this, "GetIntersectionOrNull", 1 , [anotherRange], false, true, null));
		};
	...
	var RangeViewCollection=(function (_super) {
		...
		RangeViewCollection.prototype.getItem=function (index) {
			return new Excel.RangeView(this.context, _createIndexerObjectPath(this.context, this, [index]));
		};
		RangeViewCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=new Excel.RangeView(this.context, _createChildItemObjectPathUsingIndexerOrGetItemAt(true, this.context, this, _data[i], i));
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
	...
	var NamedItemCollection=(function (_super) {
		...
		NamedItemCollection.prototype.getItemOrNull=function (name) {
			return new Excel.NamedItem(this.context, _createMethodObjectPath(this.context, this, "GetItemOrNull", 1 , [name], false, false, null));
		};
	...
	var BindingCollection=(function (_super) {
		...
		BindingCollection.prototype.getItemOrNull=function (id) {
			return new Excel.Binding(this.context, _createMethodObjectPath(this.context, this, "GetItemOrNull", 1 , [id], false, false, null));
		};
	...
	var TableCollection=(function (_super) {
		...
		TableCollection.prototype.getItemOrNull=function (key) {
			return new Excel.Table(this.context, _createMethodObjectPath(this.context, this, "GetItemOrNull", 1 , [key], false, false, null));
		};
	...
	var TableColumnCollection=(function (_super) {
		...
		TableColumnCollection.prototype.add=function (index, values) {
			return new Excel.TableColumn(this.context, _createMethodObjectPath(this.context, this, "Add", 0 , [index, values], false, true, null));
		};
		...
		TableColumnCollection.prototype.getItemOrNull=function (key) {
			return new Excel.TableColumn(this.context, _createMethodObjectPath(this.context, this, "GetItemOrNull", 1 , [key], false, false, null));
		};
	...
	var ChartCollection=(function (_super) {
		...
		ChartCollection.prototype.getItemOrNull=function (name) {
			return new Excel.Chart(this.context, _createMethodObjectPath(this.context, this, "GetItemOrNull", 1 , [name], false, false, null));
		};
	...
	Excel._V1Api=_V1Api;
	var V1CoercionType;
	(function (V1CoercionType) {
		V1CoercionType.matrix="Matrix";
		V1CoercionType.table="Table";
		V1CoercionType.text="Text";
		V1CoercionType.image="Image";
	})(V1CoercionType=Excel.V1CoercionType || (Excel.V1CoercionType={}));
	var V1TableEnum;
	(function (V1TableEnum) {
		V1TableEnum.all="All";
		V1TableEnum.data="Data";
		V1TableEnum.headers="Headers";
	})(V1TableEnum=Excel.V1TableEnum || (Excel.V1TableEnum={}));
	var PivotTableCollection=(function (_super) {
		...
		PivotTableCollection.prototype.getItemOrNull=function (name) {
			return new Excel.PivotTable(this.context, _createMethodObjectPath(this.context, this, "GetItemOrNull", 1 , [name], false, false, null));
		};
